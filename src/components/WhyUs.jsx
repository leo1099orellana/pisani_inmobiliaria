    ...
    <section className="px-3 md:px-5">
      <div className="relative rounded-2xl md:rounded-3xl overflow-hidden bg-dark min-h-[380px] py-14 px-6 md:py-16 md:px-12">
        ...
        <div className="relative text-center text-white max-w-[1280px] mx-auto">
          <h2 className="font-sans font-normal text-4xl md:text-5xl lg:text-6xl xl:text-[64px] tracking-[-0.02em] leading-none mb-12">
            {site.whyUs.title}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
            {stats.map((s, i) => (
              ...
              >
                <div className="font-sans text-5xl md:text-6xl lg:text-7xl xl:text-[88px] tracking-[-0.03em] leading-none mb-2.5">
                  {s.value}
                </div>
