        ...
        <div className="text-white max-w-[34rem]">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2.5 px-5 py-3.5 rounded-full bg-[#70B32D] text-white text-sm font-medium hover:bg-[#5A9225] transition-colors"
            >
              <img src="https://www.google.com/s2/favicons?domain=argenprop.com&sz=32" alt="" className="w-4 h-4 rounded" />
              Argenprop
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-3.5 rounded-full bg-[#FF4C00] text-white text-sm font-medium hover:bg-[#E03D00] transition-colors"
            >
              <img src="https://www.google.com/s2/favicons?domain=zonaprop.com.ar&sz=32" alt="" className="w-4 h-4 rounded bg-white p-0.5" />
              Zonaprop
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M5 12h14M13 5l7 7-7 7" />
              </svg>
